...
public class implParser extends Parser {
	...
	public static class ElseIfContext extends CommandContext {
		...
		public ElseIfContext(CommandContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).enterElseIf(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).exitElseIf(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof implVisitor ) return ((implVisitor<? extends T>)visitor).visitElseIf(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final CommandContext command() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				match(CPAR);
				setState(48);
				((IfElseStmtContext)_localctx).p1 = program();
				setState(51); 
				_errHandler.sync(this);
				_alt = 1;
				do {
			...
			case 5:
				...
				match(OPAR);
				setState(57);
				((ElseIfContext)_localctx).con1 = condition(0);
				setState(58);
				match(CPAR);
				setState(59);
				((ElseIfContext)_localctx).p1 = program();
				{
				setState(60);
				match(T__3);
				setState(61);
				match(OPAR);
				setState(62);
				((ElseIfContext)_localctx).con2 = condition(0);
				setState(63);
				match(CPAR);
				setState(64);
				((ElseIfContext)_localctx).p2 = program();
				}
				setState(68); 
				_errHandler.sync(this);
				_alt = 1;
				do {
					...
					case 1:
						...
						match(ELSE);
						setState(67);
						((ElseIfContext)_localctx).p3 = program();
						}
						}
						break;
					default:
